    ...
    async savePlantCare() {
      ...
      try {
        ...
        if (response.ok) {
          ...
          const newEvent = {
            title: `
              ${waterIcon} ${result.data.water} <br> 
              ${sunlightIcon} ${result.data.sunlight} <br> 
              ${ventilationIcon} ${result.data.ventilation} <br>  
              ${coverIcon} ${result.data.cover} <br> 
              ${nutrientsIcon} ${result.data.nutrients}
            `,
